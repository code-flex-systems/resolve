...
-- 3 Clerk users (primary dev accounts)
SELECT id FROM users WHERE email IN (
    'kendrabryant@craig680.onmicrosoft.com',
    'owenfarthing.manifest@gmail.com',
    'owenfarthing@craig680.onmicrosoft.com'
)
UNION ALL
-- Add 7 more users with variety of names for realistic claim assignments
...
UPDATE desk_location_type SET created_by = (
    SELECT id FROM users WHERE email = 'owenfarthing@craig680.onmicrosoft.com' LIMIT 1
