// generateQuestionsAnswers_fromLibraries_fixed_noOptionGroupReturn.js
'use strict';

const CLIENT_ID = '1c118f90-3153-4dfb-b350-953e42f0d1aa';

const sql = `-- Seed: questions & answers from broad libraries (page_id always valid)
-- Client: ${CLIENT_ID}
BEGIN;
...
ins_questions AS (
  ...
  SELECT
    ...
    q.placeholder,
    (random() < 0.05),
    (SELECT id FROM users WHERE client_id = '${CLIENT_ID}' AND role = 'Admin' ORDER BY random() LIMIT 1),
