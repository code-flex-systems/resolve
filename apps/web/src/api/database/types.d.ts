...
export interface Claim {
  ...
  /**
   * Current status of recovery efforts (RecoveryStatus enum enforced in TypeScript)
   */
...
export interface Party {
  ...
  deleted_at: Timestamp | null;
  /**
   * ID of user who archived this party
   */
  deleted_by: string | null;
...
export interface PartyAddress {
  ...
  deleted_at: Timestamp | null;
  /**
   * ID of user who archived this address
   */
  deleted_by: string | null;
  id: Generated<string>;
  name: string | null;
...
export interface PartyRepresentative {
  ...
  deleted_at: Timestamp | null;
  /**
   * ID of user who archived this representative
   */
  deleted_by: string | null;
  email: string | null;
  fax: string | null;
