...
export async function up(db: Kysely<any>): Promise<void> {
	...
	await db.schema.alterTable('recovery_event').addColumn('deleted_at', 'timestamptz').execute();

	await db.schema.alterTable('recovery_event').addColumn('deleted_by', 'text').execute();
