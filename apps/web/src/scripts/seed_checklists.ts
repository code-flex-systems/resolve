	...
	pages: [
		{
			...
			questions: [
				{
					text: 'Has the date of loss been verified?',
					type: 'single',
					answers: ['Yes', 'No', 'Pending verification'],
				},
				{
					text: 'Was the claim reported within the policy reporting window?',
					type: 'single',
					answers: ['Yes', 'No', 'Under review'],
				},
				{ text: "What is the insured's policy number?", type: 'freeform', answers: [''] },
				{
					text: "Has the insured's identity been confirmed?",
					type: 'single',
					answers: ['Yes', 'No'],
				},
				{
					text: 'What type of loss occurred?',
					type: 'dropdown',
					answers: [
						'Collision',
						'Comprehensive',
				...
				{
					text: 'Were there any witnesses to the incident?',
					type: 'single',
					answers: ['Yes', 'No', 'Unknown'],
				},
				{
					text: 'Has a police report been filed?',
					type: 'single',
					answers: ['Yes', 'No', 'Not applicable'],
				},
				{ text: 'Police report number (if applicable):', type: 'freeform', answers: [''] },
				{
					text: "Is the insured's coverage confirmed and active?",
					type: 'single',
					answers: [
						'Yes - coverage confirmed',
						'No - coverage issue identified',
						'Pending verification',
					],
					unlockChildIndex: 0,
					unlockChildTitle: 'Coverage Analysis',
				},
			...
			children: [
				{
					...
					questions: [
						...
						{
							text: 'Select all applicable coverage types:',
							type: 'multi',
							answers: [
								'Collision',
								'Comprehensive',
						...
						{
							text: 'What is the comprehensive deductible amount?',
							type: 'freeform',
							answers: [''],
						},
						{ text: 'What are the liability limits?', type: 'freeform', answers: [''] },
						{
							text: 'Are there any policy exclusions that may apply?',
							type: 'single',
							answers: ['Yes', 'No', 'Under review'],
						},
						{ text: 'Describe any applicable exclusions:', type: 'freeform', answers: [''] },
						{
							text: 'Are multiple coverages applicable to this loss?',
							type: 'single',
							answers: ['Yes', 'No'],
							unlockChildIndex: 0,
							unlockChildTitle: 'Multi-Coverage Breakdown',
						},
					...
					children: [
						{
							...
							questions: [
								...
								{
									text: 'What is the primary coverage?',
									type: 'dropdown',
									answers: [
										'Collision',
										'Comprehensive',
								...
								{
									text: 'Are there coordination of benefits issues?',
									type: 'single',
									answers: ['Yes', 'No'],
								},
								{
									text: 'What is the total combined coverage limit?',
									type: 'freeform',
									answers: [''],
								},
								{
									text: 'Is there potential for subrogation on any coverage?',
									type: 'single',
									answers: ['Yes', 'No', 'Pending evaluation'],
								},
		...
		},
		{
			...
			questions: [
				{
					text: 'What is the year, make, and model of the vehicle?',
					type: 'freeform',
					answers: [''],
				},
				...
				{
					text: 'Were photos of the damage obtained?',
					type: 'single',
					answers: ['Yes', 'No', 'Pending'],
				},
				{ text: 'Is the vehicle drivable?', type: 'single', answers: ['Yes', 'No'] },
				{
					text: 'Were airbags deployed?',
					type: 'single',
					answers: ['Yes', 'No', 'Not applicable'],
				},
				{
					text: 'Has a repair estimate been obtained?',
					type: 'single',
				...
				{
					text: 'Is the vehicle repairable?',
					type: 'single',
					answers: ['Yes', 'No - total loss'],
					unlockChildIndex: 1,
					unlockChildTitle: 'Total Loss Evaluation',
				},
			...
			children: [
				{
					...
					questions: [
						{
							text: 'What is the fair market value of the vehicle?',
							type: 'freeform',
							answers: [''],
						},
						{ text: 'What is the estimated salvage value?', type: 'freeform', answers: [''] },
						{
							text: 'Does repair cost exceed the total loss threshold?',
							type: 'single',
							answers: ['Yes', 'No'],
						},
						{
							text: 'Has the owner been notified of total loss determination?',
							type: 'single',
							answers: ['Yes', 'No', 'Pending'],
						},
						{
							text: 'Does the owner wish to retain the vehicle?',
							type: 'single',
		...
		},
		{
			...
			questions: [
				{
					text: 'Has the police report been reviewed?',
					type: 'single',
					answers: ['Yes', 'No', 'Not available'],
				},
				{
					text: 'What is the preliminary fault determination?',
					type: 'dropdown',
					answers: [
						'Insured at fault',
				...
				{
					text: 'What percentage of fault is attributed to the insured?',
					type: 'freeform',
					answers: [''],
				},
				{
					text: 'Were any traffic citations issued?',
					type: 'single',
					answers: ['Yes - to insured', 'Yes - to third party', 'Yes - to both', 'No'],
				},
				{
					text: 'Were witness statements obtained?',
					type: 'single',
					answers: ['Yes', 'No', 'In progress'],
				},
				{
					text: 'Is there dash cam or surveillance footage?',
					type: 'single',
					answers: ['Yes', 'No', 'Being requested'],
				},
				{
					text: 'Does comparative negligence apply in this jurisdiction?',
					type: 'single',
					answers: ['Yes', 'No'],
				},
				{
					text: 'What negligence standard applies?',
					type: 'dropdown',
					answers: [
						'Pure comparative',
				...
				{
					text: 'Is a third party involved?',
					type: 'single',
					answers: ['Yes', 'No'],
					unlockChildIndex: 0,
					unlockChildTitle: 'Third Party Details',
				},
			...
			children: [
				{
					...
					questions: [
						...
						{
							text: 'Has contact been made with the third party carrier?',
							type: 'single',
							answers: ['Yes', 'No', 'Attempted'],
						},
						{
							text: 'Has the third party accepted liability?',
							type: 'single',
							answers: ['Yes', 'No', 'Pending'],
						},
		...
		},
		{
			...
			questions: [
				...
				{
					text: 'Was emergency medical treatment required?',
					type: 'single',
					answers: ['Yes', 'No'],
				},
				{
					text: 'Have medical records been requested?',
					type: 'single',
					answers: ['Yes', 'No', 'Not applicable'],
				},
				{
					text: 'Have medical bills been received?',
					type: 'single',
					answers: ['Yes', 'No', 'Pending'],
				},
				{ text: 'Total medical expenses to date:', type: 'freeform', answers: [''] },
				{
					text: 'Is PIP or MedPay coverage applicable?',
					type: 'single',
					answers: ['Yes - PIP', 'Yes - MedPay', 'Both', 'Neither'],
				},
				{
					text: 'Is the injured party still receiving treatment?',
					type: 'single',
					answers: ['Yes', 'No', 'Unknown'],
				},
		...
		},
		{
			...
			questions: [
				{
					text: 'Is there subrogation potential?',
					type: 'single',
					answers: ['Yes', 'No', 'Under evaluation'],
				},
				...
				{
					text: 'Has a demand letter been sent?',
					type: 'single',
					answers: ['Yes', 'No', 'In preparation'],
				},
				{ text: 'Date demand letter was sent:', type: 'freeform', answers: [''] },
				{
					text: 'Has a response been received?',
					type: 'single',
					answers: ['Yes', 'No', 'Pending'],
				},
		...
		},
		{
			...
			questions: [
				{ text: 'What is the proposed settlement amount?', type: 'freeform', answers: [''] },
				{
					text: 'Has the settlement been approved?',
					type: 'single',
					answers: ['Yes', 'No', 'Pending approval'],
				},
				{
					text: 'Payment method:',
					type: 'dropdown',
					answers: ['Check', 'Direct deposit', 'Wire transfer', 'Directed to repair facility'],
				},
				{ text: 'Has a release been obtained?', type: 'single', answers: ['Yes', 'No', 'Pending'] },
				{
					text: 'Have all liens been satisfied?',
					type: 'single',
					answers: ['Yes', 'No', 'Not applicable'],
				},
				{
					text: 'Has the insured been notified of resolution?',
					type: 'single',
					answers: ['Yes', 'No'],
				},
				...
				{
					text: 'Is this claim ready to close?',
					type: 'single',
					answers: ['Yes', 'No - pending items remain'],
				},
			],
		},
	],
	...
	pages: [
		{
			...
			questions: [
				...
				{
					text: 'Type of property damage:',
					type: 'dropdown',
					answers: ['Fire', 'Water damage', 'Wind/Storm', 'Theft', 'Vandalism', 'Other'],
				},
				{ text: 'Property address:', type: 'freeform', answers: [''] },
				{
					text: 'Is the property owner-occupied or rental?',
					type: 'single',
					answers: ['Owner-occupied', 'Rental', 'Vacant'],
				},
				{
					text: 'Was the property secured after the loss?',
					type: 'single',
					answers: ['Yes', 'No', 'Pending'],
				},
				...
				{
					text: 'Has an inspection been scheduled?',
					type: 'single',
					answers: ['Yes', 'No', 'In progress'],
					unlockChildIndex: 0,
					unlockChildTitle: 'Property Inspection',
				},
			...
			children: [
				{
					...
					questions: [
						...
						{
							text: 'Overall condition of the property:',
							type: 'dropdown',
							answers: [
								'Good - minor damage',
						...
						{
							text: 'Were photos taken during inspection?',
							type: 'single',
							answers: ['Yes', 'No'],
						},
						{
							text: 'Is the damage consistent with the reported loss?',
							type: 'single',
						...
						{
							text: 'Is there significant structural damage?',
							type: 'single',
							answers: ['Yes', 'No'],
							unlockChildIndex: 0,
							unlockChildTitle: 'Detailed Damage Assessment',
						},
					...
					children: [
						{
							...
							questions: [
								{
									text: 'Which structural elements are affected?',
									type: 'multi',
									answers: [
										'Foundation',
										'Load-bearing walls',
								...
								{
									text: 'Is the structure safe for occupancy?',
									type: 'single',
									answers: ['Yes', 'No', 'Conditional'],
								},
								{
									text: 'Has an engineer assessment been requested?',
									type: 'single',
									answers: ['Yes', 'No'],
								},
		...
		},
		{
			...
			questions: [
				...
				{
					text: 'Select all applicable coverages:',
					type: 'multi',
					answers: [
						'Dwelling',
						'Personal property',
				...
				{
					text: 'Is replacement cost or actual cash value applicable?',
					type: 'single',
					answers: ['Replacement cost', 'Actual cash value'],
				},
				{
					text: 'Are there any exclusions that may apply?',
					type: 'single',
					answers: ['Yes', 'No'],
				},
				{
					text: 'Is additional living expense (ALE) applicable?',
					type: 'single',
					answers: ['Yes', 'No'],
					unlockChildIndex: 0,
					unlockChildTitle: 'Additional Living Expense',
				},
			...
			children: [
				{
					...
					questions: [
						{
							text: 'Is the property uninhabitable?',
							type: 'single',
							answers: ['Yes', 'No', 'Partially'],
						},
						...
						{
							text: 'Has the insured submitted ALE receipts?',
							type: 'single',
							answers: ['Yes', 'No'],
						},
		...
		},
		{
			...
			questions: [
				{
					text: 'Has a contractor been selected?',
					type: 'single',
					answers: ['Yes', 'No', 'Getting estimates'],
				},
				{ text: 'Contractor name:', type: 'freeform', answers: [''] },
				{
					text: 'Is the contractor licensed and insured?',
					type: 'single',
					answers: ['Yes', 'No', 'Pending verification'],
				},
				{
					text: 'Has a scope of work been agreed upon?',
					type: 'single',
					answers: ['Yes', 'No', 'In negotiation'],
				},
				...
				{
					text: 'Are multiple vendors needed?',
					type: 'single',
					answers: ['Yes', 'No'],
					unlockChildIndex: 0,
					unlockChildTitle: 'Vendor Coordination',
				},
				{
					text: 'Have change orders been submitted?',
					type: 'single',
					answers: ['Yes', 'No', 'Not yet applicable'],
				},
			...
			children: [
				{
					...
					questions: [
						...
						{
							text: 'Has a lead contractor been designated?',
							type: 'single',
							answers: ['Yes', 'No'],
						},
						{
							text: 'Are vendor schedules coordinated?',
							type: 'single',
							answers: ['Yes', 'No', 'In progress'],
						},
		...
		},
		{
			...
			questions: [
				{
					text: 'Has a contents inventory list been submitted?',
					type: 'single',
					answers: ['Yes', 'No', 'In progress'],
				},
				...
				{
					text: 'Have receipts or proof of ownership been provided?',
					type: 'single',
					answers: ['Yes - for all items', 'Yes - for some items', 'No'],
				},
				{
					text: 'Has the inventory been verified?',
					type: 'single',
					answers: ['Yes', 'No', 'In progress'],
				},
				{
					text: 'Are there any high-value items (over $5,000)?',
					type: 'single',
					answers: ['Yes', 'No'],
				},
				{ text: 'List any high-value items:', type: 'freeform', answers: [''] },
				{
					text: 'Is replacement cost or ACV being applied to contents?',
					type: 'single',
					answers: ['Replacement cost', 'ACV'],
				},
		...
		},
		{
			...
			questions: [
				{
					text: 'Is there a responsible third party?',
					type: 'single',
					answers: ['Yes', 'No', 'Under investigation'],
				},
				{ text: 'Name of responsible party:', type: 'freeform', answers: [''] },
				{
					text: 'Has a demand been sent?',
					type: 'single',
					answers: ['Yes', 'No', 'In preparation'],
				},
				{ text: 'What is the estimated recovery amount?', type: 'freeform', answers: [''] },
				...
				{
					text: 'Has deductible reimbursement been arranged?',
					type: 'single',
					answers: ['Yes', 'No', 'Not applicable'],
				},
		...
		},
		{
			...
			questions: [
				...
				},
				{
					text: 'Payment method:',
					type: 'dropdown',
					answers: ['Check', 'Direct deposit', 'Wire transfer', 'Directed to contractor'],
				},
				{
					text: 'Has the insured signed the proof of loss?',
					type: 'single',
					answers: ['Yes', 'No'],
				},
				{
					text: 'Are there any holdbacks for recoverable depreciation?',
					type: 'single',
					answers: ['Yes', 'No'],
				},
				{
		...
		pages: [
			{
				...
				questions: [
					...
					{
						text: 'Has the policy been verified?',
						type: 'single',
						answers: ['Yes', 'No', 'Pending'],
					},
				],
			},
			{
				...
				questions: [
					{
						text: 'What is the current investigation status?',
						type: 'dropdown',
						answers: ['Not started', 'In progress', 'Complete'],
					},
				...
				questions: [
					{
						...
						type: 'dropdown',
						answers: ['Settlement', 'Denial', 'Litigation', 'Pending'],
					},
...
function generateFreeformResponse(questionText: string): string {
	...
	if (
		...
		return 'John Smith';
	if (lower.includes('number') || lower.includes('vin') || lower.includes('policy'))
		return 'POL-2026-48291';
	...
	if (
		...
		lower.includes('circumstances') ||
		lower.includes('items') ||
		lower.includes('specialties') ||
		lower.includes('coverages') ||
		lower.includes('information') ||
		lower.includes('status') ||
		lower.includes('timeline')
	)
		return 'Reviewed and documented per standard procedures.';
...
async function wipeTables(): Promise<void> {
	...
	await sql`TRUNCATE TABLE question_response_answer, question_response, page_instance_status, answer_call_edges, answer, question, page_instance, page, checklist_claim, checklist, comment, action, action_log CASCADE`.execute(
		db
	);
...
async function insertChecklist(def: ChecklistDef, adminId: string): Promise<InsertedChecklist> {
	return db.transaction().execute(async (trx) => {
		...
		for (const link of unlockLinks) {
			...
			if (!targetInstance) {
				console.warn(
					`  WARNING: Could not find child instance "${link.childTitle}" for unlock link`
				);
				continue;
			}
			...
			const fromInstance = allInstances.find((inst) =>
				inst.questions.some((q) => q.answers.some((a) => a.answerId === link.answerId))
			);
