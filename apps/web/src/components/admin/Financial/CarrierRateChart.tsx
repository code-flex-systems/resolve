...
export default function CarrierRateChart({ data }: Props) {
	...
	return (
		<Card variant="beveled" padding="none" style={{ padding: '24px' }}>
			<h3 style={{ margin: '0 0 16px' }}>Recovery Rate by Carrier</h3>
			<ResponsiveContainer width="100%" height={350}>
				<BarChart data={data} layout="vertical" margin={{ left: 120 }}>
					...
					<ReferenceLine x={avgRate} stroke="#ba68c8" strokeDasharray="3 3" label={{ value: `Avg ${avgRate.toFixed(1)}%`, position: 'top', fontSize: 11 }} />
