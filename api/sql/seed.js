...
for (let i = 1; i <= numClaims; i++) {
	...
	statements.push(
		`INSERT INTO claim (id,checklist_id,claim_number,client,client_adjuster,insured,claim_amount,total_incurred,date_of_loss,loss_location,last_updated_by,last_update,expected_recovery) ` +
			`VALUES (${i},${checklistId},'${claimNumber}','${client}','${adjuster}','${insured}',${claimAmount},${totalIncurred},'${dateOfLoss}','${lossLocation}','${updater}','${lastUpdate}',${expectedRec});`
	);
}
